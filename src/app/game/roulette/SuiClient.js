...
// This is now handled by the SuiClientProvider
// You can access the client via hooks in components

import { useSuiClient } from '@mysten/dapp-kit';

export function useSuiClientOperations() {
  const suiClient = useSuiClient();
  
  return {
    suiClient,
    // Add any custom client operations here
  };
}